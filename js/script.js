...
(function () {
	...
	$(function () {
		...
		function attachFormValidator(elements) {
			...
			regula.custom({
				name: 'PhoneNumber',
				defaultMessage: 'Номеріңізді толық жазыңыз',
				validator: function() {
			...
			var regularConstraintsMessages = [
				{
					...
					newMessage: "Хабарлама жіберетін жерді толықтырыңыз."
				},
				{
					type: regula.Constraint.Email,
					newMessage: "Email жазыңыз ."
				},
				{
					type: regula.Constraint.Numeric,
					newMessage: "Номеріңізді жазыңыз толық"
				},
				{
					type: regula.Constraint.Selected,
					newMessage: "Есіміңізді жазыңыз."
				}
			];
		...
		if (plugins.rdMailForm.length) {
			var i, j, k,
				...
				$recipients = 'Xudaibergenovirisbek@gmail.com'
